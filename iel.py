...
def get_1(u1, u2, r1, r2, r3, r4, r5, r6, r7, r8):
    ...
    rstar = delta_star(r1, r5, r234)

    print("Ra {} \n rb {} \n Rc {} \n".format(rstar[0],rstar[1],rstar[2]))


    rc7 = rstar[2] + r7
    rb6 = rstar[1] + r6
    print(" rb6 {}".format(rb6))

    rc7b6 = pararell(rc7, rb6)

    rc7b6a = serial(rstar[0], rc7b6)
    rekv = serial(rc7b6a, r8)

    print(" Celkový odpor {}".format(rekv))

    i = (u1+u2) / rekv

    print(" Celkový prpud {}".format(i))

    urc7b6 = i * rc7b6
    # print(" Celkový odpor {}".format(urc7b6))

    irc6 = urc7b6 / rb6
    print(" Ir6: {}".format(irc6))
    ur6 = irc6 * r6
    print(" Ur6: {}".format(ur6))

def get_2(u, r1, r2, r3, r4, r5, r6):
    ri = (r1+r4+r5)*(r2+r6)/(r1+r4+r5)+(r2+r6)
    ...
    ur2 = u*(r2/(r1+r2))
    ur3 = ur2-ur1
    print("Napětí Ur3 je rovno: {}".format(ur3))

    i3 = u/(ri+r2)
    print("Napětí i3 je rovno: {}".format(i3))
...
test_codes = {
    'me': 'ECBED',       # your test code preset goes here
